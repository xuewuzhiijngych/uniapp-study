...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"demo","VUE_APP_PLATFORM":"mp-toutiao","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 4 */
/*!**********************************************************!*\
  !*** C:/Users/Administrator/Desktop/002/demo/pages.json ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 12 */
/*!**************************************************************!*\
  !*** C:/Users/Administrator/Desktop/002/demo/store/index.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _vuex = _interopRequireDefault(__webpack_require__(/*! vuex */ 8));var _Vuex$Store;function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
_vue.default.use(_vuex.default);
var store = new _vuex.default.Store((_Vuex$Store = {
  state: {},


  mutations: {} }, _defineProperty(_Vuex$Store, "state",
...
{ // 全局方法定义处
  // 微信授权登录
  wxLogin: function wxLogin(state, provider) {
  ...
  // 退出微信登录
  wxLoginOut: function wxLoginOut(state, provider) {
  ...
  // 是否登录
  isLogin: function isLogin(state, callback) {
  ...
  // 字节跳动授权登录
  zjLogin: function zjLogin(state, provider) {
  ...
  // 退出字节跳动登录
  zjLoginOut: function zjLoginOut(state, provider) {
    ...
    console.log('退出登录成功');
  } }), _defineProperty(_Vuex$Store, "actions",

{}), _Vuex$Store));var _default =
...
/* 13 */
/*!*************************************************************!*\
  !*** C:/Users/Administrator/Desktop/002/demo/utils/vphp.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(uni) {var vphp = {};
...
// 弹出确认框
vphp.confirm = function (title, content, _success, cancel) {
  ...
  var confirmText;
  if (_success instanceof Array) {
    confirmText = _success[0];
    _success = _success[1];
  }
  var cancelText;
...
vphp.alert = function (title, content, _success2) {
  if ('function' == typeof content || 'object' == typeof content) {
    _success2 = content;
    content = title;
    title = null;
  ...
  var confirmText;
  if (_success2 instanceof Array) {
    confirmText = _success2[0];
    _success2 = _success2[1];
  }
  var params = {
    content: content,
    showCancel: false,
...
// url操作
vphp.url = {
  build: function build(url, params) {
    if (!params) {
      return url;
    }
    for (var k in params) {
...
vphp.cookie = {
  ...
  /**
      ...
      */
  set: function set(key, value, expiry) {
    this._init();
...
vphp._api = function (options) {
  ...
  var event = {
    success: function success(data, extras) {
      if (the.success) {
        var args = [];
        args.push(data);
        if (extras) {
